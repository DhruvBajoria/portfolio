...
const Hero = () => {
  ...
  const handleViewResume = () => {
    // https://drive.google.com/file/d/1SXrQSUxhPyeTcCgpl2Gmb1MPZn_9DJ82/view?usp=drive_link
    const fileId = "file/d/1SXrQSUxhPyeTcCgpl2Gmb1MPZn_9DJ82/view";
    ...
    <div className="min-h-screen bg-gray-900 flex flex-col justify-center items-center p-4">
      ...
      <div className="max-w-6xl w-full text-center">
        ...
        <h1 className="text-4xl md:text-5xl font-bold text-white mb-8">
          <TypewriterEffect
            html={
              "Hey, I'm Dhruv Bajoria - Software <span class='text-blue-400'> Engineer</span>"
            }
            speed={50}
          />
        </h1>
